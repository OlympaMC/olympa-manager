...
public @interface CmdDiscord {
	 ...
	 */
	public boolean bot() default false;
	 ...
	 * Add aliases in .help
	 */
	public boolean registerAliasesAsCommand() default false;

	/**
	 * Trigger command in MP. It won't be trigger in guild
	 */
	public boolean triggerPrivateChannel() default false;

	/**
	 * Trigger when the message is edited too
	 */
	public boolean triggerEditedMsg() default true;

	/**
	 * Trigger on Olympa Staff Discord
	 */
	public boolean triggerOnOwnPrivateServer() default true;

	/**
	 * Trigger on Olympa Public Discord
	 */
	public boolean triggerOnOwnServer() default true;

	/**
	 * Trigger on Others Servers
	 */
	public boolean triggerOnPublicsServers() default true;
}